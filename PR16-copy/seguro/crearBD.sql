...
create database if not exists PR16;
use PR16;
...
/* Usuarios */
insert into usuarios (usuario,contraseña,email,fecha_nacimiento,perfil) values ('u1','usuarioAd1','imc@correo.es',DATE '2021/12/19','P_ADMIN');
insert into usuarios (usuario,contraseña,email,fecha_nacimiento,perfil) values ('u2','usuarioMd1','abc@correo.es',DATE '2021/07/25','P_MODERADOR');
insert into usuarios (usuario,contraseña,email,fecha_nacimiento,perfil) values ('u3','usuarioNr1','tbc@correo.es',DATE '2021/04/03','P_NORMAL');
